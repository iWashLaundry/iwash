  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <dl class="row">
          <dt class="col-sm-7">Order ID</dt>
          <dd class="col-sm-5 text-right">@{{ wc.orderService.order.order_id }}</dd>

          <dt class="col-sm-7">First Name</dt>
          <dd class="col-sm-5 text-right">@{{ wc.orderService.order.customer_first_name }}</dd>

          <dt class="col-sm-7">Last Name</dt>
          <dd class="col-sm-5 text-right">@{{ wc.orderService.order.customer_last_name }}</dd>
          ...
          <dt class="col-sm-7">Registration</dt>
          <dd class="col-sm-5 text-right">@{{ wc.orderService.order.customer_id > 0 ? 'Registered' : 'Not Registered' }}</dd>
